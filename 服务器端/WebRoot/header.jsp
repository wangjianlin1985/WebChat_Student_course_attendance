...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">学生考勤系统</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>CourseType/frontlist">课程类型</a></li>
                <li><a href="<%=basePath %>Course/frontlist">课程列表</a></li>
                <li><a href="<%=basePath %>OrderInfo/frontlist">考勤记录</a></li>  
